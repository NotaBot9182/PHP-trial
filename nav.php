        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/laracasts/demo/index.php" <?php echo $_SERVER['REQUEST_URI'] === '/laracasts/demo/index.php' ? 'aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"' : 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"' ?>>Home</a>
              <a href="/laracasts/demo/about.php" <?php echo $_SERVER['REQUEST_URI'] === '/laracasts/demo/about.php' ? 'aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"' : 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"' ?>>About</a>
              <a href="/laracasts/demo/contact.php" <?php echo $_SERVER['REQUEST_URI'] === '/laracasts/demo/contact.php' ? 'aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"' : 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"' ?>>Contact</a>
             <a href="/laracasts/demo/notes.php" <?php echo $_SERVER['REQUEST_URI'] === '/laracasts/demo/notes.php' ? 'aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"' : 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"' ?>>Notes</a>
